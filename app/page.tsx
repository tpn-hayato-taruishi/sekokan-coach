...
**C. 禁止事項:**
- 「正答に出現」「誤答に出現」という言い方 (位置と事実を混同するので禁止)
...
・[ラベル] 「○○は△△」 — 根拠: 例X(肯定形・正答位置), 例Y(否定形・誤答位置で同事実を確認)
例: [📊頻出] 「主任電気工事士=第一種電気工事士」 — 例3(肯定形・正答1番), 例4(肯定形・正答1番), 例7(肯定形)

【⚠ 引っ掛けで出る "実際は違う" 定石 (=偽の事実)】 (最大4個、根拠付き)
・[ラベル] 「○○ではない」 — 根拠: 例X(否定形・正答位置=この文は虚偽), 例Y(肯定形・誤答位置=同様)
例: [📊頻出] 「主任電気工事士に "一級電気工事施工管理技士" は含まれない」 — 例3(肯定形)の選択肢4(誤答), 例6(肯定形)の選択肢4(誤答), 本問(否定形)の選択肢2(正答=この文が虚偽)
