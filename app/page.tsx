  ...
  '2級': [
    {
      ...
      note: '第一次検定に名称変更。応用能力問題(No.50-52)が新設され独立して50%以上必要に。',
      groups: [
        ...
        { name: '設計図書・契約', subject: '施工管理法', no: 'No.38～39', out: 2, must: 2, type: '必須' },
        { name: '施工管理法', subject: '施工管理法', no: 'No.40～49', out: 10, must: 10, type: '必須' },
        { name: '施工管理法 (応用能力)', subject: '施工管理法', no: 'No.50～52', out: 3, must: 3, type: '必須(50%以上)' },
    ...
    },
    {
      ...
      groups: [
        ...
        { name: '関連分野', subject: '電気設備', no: 'No.33～37', out: 5, must: 5, type: '必須' },
        { name: '設計図書・契約', subject: '施工管理法', no: 'No.38～39', out: 2, must: 2, type: '必須' },
        { name: '施工管理法', subject: '施工管理法', no: 'No.40～52', out: 13, must: 13, type: '必須' },
        { name: '法規', subject: '法規', no: 'No.53～64', out: 12, must: 10, type: '選択' },
      ],
    },
  ],
